/**
 * GBA character map for decoding Pokemon nicknames and trainer names.
 * Index = byte value, value = character string.
 */
const CHARMAP: Record<number, string> = {
  ...
  0xA9: '8', 0xAA: '9', 0xAB: '!', 0xAC: '?', 0xAD: '.', 0xAE: '-',
...
export function decodeGBAString(bytes: Uint8Array, maxLength: number): string {
  let result = '';
